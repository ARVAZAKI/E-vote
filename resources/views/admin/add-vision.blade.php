...
<div class="container-fluid">
    <div class="card shadow-lg">
      <div class="card-body">
        <h5 class="card-title fw-semibold mb-4">Add Vision</h5>
        <div class="card">
          ...
          @endif
          <div class="card-body">
            <form action="{{route('createVision')}}" method="post">
                @csrf
             <div class="mb-3">
...
<script>
  ...
  function addInput() {
      ...
      const newInput = `
          <div class="mb-3">
              <input type="text" class="form-control" id="vision${counter}" name="vision${counter}" value="">
          </div>`;
